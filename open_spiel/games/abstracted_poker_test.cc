...
int main(int argc, char **argv) {
  open_spiel::universal_poker::abstracted_poker::LoadKuhnLimitWithAndWithoutGameDef();
  open_spiel::universal_poker::abstracted_poker::LoadHoldemNoLimit6PWithAndWithoutGameDef();

  open_spiel::universal_poker::abstracted_poker::LoadAndRunGamesFullParameters();

  open_spiel::universal_poker::abstracted_poker::LoadGameFromDefaultConfig();
  open_spiel::universal_poker::abstracted_poker::LoadAndRunGameFromGameDef();
  open_spiel::universal_poker::abstracted_poker::LoadAndRunGameFromDefaultConfig();

  open_spiel::universal_poker::abstracted_poker::BasicUniversalPokerTests();
}
